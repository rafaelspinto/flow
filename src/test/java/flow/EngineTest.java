...
public class EngineTest {
  ...
  public void testRun_FlowIsEmpty_ThrowEmptyFlowException() throws EmptyFlowException, AdapterNotFoundException {
    engine = new Engine(mock(IAgent.class), mock(Map.class), mock(IApp.class));
    engine.run();
  }

  @Test(expected = AdapterNotFoundException.class)
  public void testRun_AdapterDoesNotExist_ThrowAdapterNotFoundException() throws EmptyFlowException, AdapterNotFoundException {
    engine = new Engine(new TextAgent("msg"), mock(Map.class), mock(IApp.class));
    engine.run();
  }

  @Test
  public void testRun_FlowHasThreeActions_ReturnAcknowledgedResponses() throws EmptyFlowException, AdapterNotFoundException {
